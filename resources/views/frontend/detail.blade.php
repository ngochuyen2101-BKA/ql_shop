										...
										<div class="col-md-6 info">
											<div class="panel panel-blue">
												...
												<div class="panel-body">
													...
													<strong class="qwert"><span class="glyphicon info-admin" aria-hidden="true"></span>Phí Ship :  {{ $ghtk->fee }}</strong>
													<br>
													<strong class="qwert"><span class="glyphicon info-admin" aria-hidden="true"></span>Thời gian lấy hàng : {{ $ghtk->estimated_deliver_time }}</strong><br>
												</div>
											</div>
										</div>
									</div>
