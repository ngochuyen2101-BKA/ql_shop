		...
		<div class="row">
			<div class="col-xs-12 col-md-12 col-lg-12">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">Danh sách đơn đặt hàng đã xác nhận</div>
                                    ...
                                    <tbody>
										@foreach ($customers as $customer)
											<tr>
												...
												<td>
													<a href="/admin/order/confirm-detail/{{ $customer->id }}" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i>Chi tiết</a>
												</td>
											</tr>
										@endforeach
