...
@section('title','Chi tiết đơn hàng vận chuyển GHTK')
@section('order')
	class="active"
@endsection
@section('content')	
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Chi tiết đơn hàng vận chuyển GHTK</li>
			</ol>
		</div>
		<!--/.row-->
		<div class="row">
			<div class="col-xs-12 col-md-12 col-lg-12">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">Chi tiết đơn hàng vận chuyển GHTK</div>
